I have a secret code in mind. It's a 4-digit code with each digit ranging between 0 and 5. I'll give you a couple example guesses, and for each guess I'll tell you two numbers:
...
2 3
The response is the way it is because the first and last digit were in the correct place (first response number is therefore 2) and additionally the second digit in the guess was present in the code at either right or wrong position (second response number is therefore 3).
